...
int main() {
    ...
    printf("\nDigite o número de casas e a direção para o BISPO avançar:\n");
    ...
    printf("\nDigite o número de casas e a direção para a TORRE avançar:\n");
    printf("Número de Casas: \n");
    scanf("%d", &torre);
    printf("Direção: \n");
    scanf("%s", dir_torre);
    ...
    printf("\nDigite o número de casas e a direção para a RAÍNHA avançar:\n");
    printf("Número de Casas: \n");
    scanf("%d", &rainha);
    printf("Direção: \n");
    scanf("%s", dir_rainha);
